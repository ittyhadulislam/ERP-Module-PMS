...
import { useReworkPriceMutation } from "../../../redux/features/scm/priceComparison/mutationPriceComparison";
import {
  useGetMDViewQuery,
  useGetReportQuery,
...
const MD = ({ showMDRW }) => {
  ...
  const {
    ...
    refetch,
  } = useGetMDViewQuery(user?.userName);
