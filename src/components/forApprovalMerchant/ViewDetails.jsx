...
import { useLazyGetMerchantViewDetailsQuery } from "../../redux/features/gatePass/merchantForApproval/merchantForApprovalQuery";
...
const ViewDetails = ({ company }) => {
  ...
  const [getViewDetails, { data, isLoading }] =
    useLazyGetMerchantViewDetailsQuery();
  useEffect(() => {
    company && getViewDetails(company?.nCompanyID);
  }, [company]);
  // Get Report Query
