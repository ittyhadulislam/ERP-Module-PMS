...
} from "../../../redux/features/weaving/costingForApproval/mutationCostingForApproval";
...
const [viewModalOpen, setViewModalOpen] = useState(false);
  ...
  const { data, isLoading, refetch } = useGetCostingMDViewQuery(undefined, {
  ...
  const columns = [
    ...
    {
      field: "scmApprovedUser",
      headerName: "Check By SCM-Head",
      minWidth: 80,
      flex: 1,
    },
    {
      field: "scmApprovedDate",
    ...
    {
      field: "dmmApprovedUser",
      headerName: "Check By DMM",
      minWidth: 80,
      flex: 1,
    },
    {
      field: "dmmApprovedDate",
      headerName: "Check By Date",
      valueGetter: (params) => formateDate(params.value),
    ...
    {
      field: "gmApprovedUser",
      headerName: "Check By GM",
      minWidth: 80,
      flex: 1,
    },
    {
      field: "gmApprovedDate",
      headerName: "Check By Date",
      valueGetter: (params) => formateDate(params.value),
      ...
      field: "internalAuditApprovedUser",
      headerName: "Check By Internal Audit",
      minWidth: 80,
      flex: 1,
    },
    {
      field: "internalAuditApprovedDate",
      headerName: "Check By Date",
      valueGetter: (params) => formateDate(params.value),
      ...
      field: "mdApprovedUser",
      headerName: "Check By MD",
      minWidth: 80,
      flex: 1,
    },
    {
      field: "mdApprovedDate",
      headerName: "Check By Date",
      valueGetter: (params) => formateDate(params.value),
          ...
          <span>
            {/* <SubmitButton
              ...
              loading={approvalLoading}
                // disabled={selectedRows.length <= 0 || showMD}
            /> */}
               <ReturnButton
                title={"md-Re-work"}
                type="button"
                ...
                loading={isLoading}
                // disabled={selectedRow.length <= 0 || showMDRW}
              />
          </span>
        </Stack>
      </Box>
