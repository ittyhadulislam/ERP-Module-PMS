...
import { useLazyNextImportLocalQuery } from "../../../redux/features/commercial/importInvoiceLocal/queryLocal";

const InvoiceLocalButton = ({ setGoToTab }) => {
  const { supplier, b2bLc, ref, invoice, date, adjustments, addGrnList } =
    useSelector((state) => state.localInvoice);
  // get next api
  const [getNext, { data, isLoading, error }] = useLazyNextImportLocalQuery();
...
export default InvoiceLocalButton;
