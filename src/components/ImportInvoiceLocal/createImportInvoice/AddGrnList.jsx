...
import { useLazyGetLocalPiDeleteQuery } from "../../../redux/features/commercial/importInvoiceLocal/queryLocal";
...
const AddGrnList = () => {
  ...
  // get delete
  const [getDelete, { data, error }] = useLazyGetLocalPiDeleteQuery();
