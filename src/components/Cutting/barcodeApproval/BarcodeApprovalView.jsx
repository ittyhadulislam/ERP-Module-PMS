...
import { useGetInputApprovalReportQuery } from "../../../redux/features/cutting/inputApproval/queryInputApproval";
import { Box } from "@mui/material";
import { useGetBarcodeApprovalQuery } from "../../../redux/features/cutting/barcodeApproval/queryBarcodeApproval";
import ReportViewer from "../../report/ReportViewer";

const BarcodeApprovalview = () => {
  ...
  const { data: approvalData, isLoading: isApprovalLoading } =
    useGetBarcodeApprovalQuery(user?.companyID);
  // report api
  ...
  return (
    <>
      <CustomTable
        ...
        height={approvalView?.length > 0 ? "auto" : "280px"}
        //   isSuccess={isSuccess}
      />
      <ReportViewer
        modalOpen={modalOpen}
...
export default BarcodeApprovalview;
