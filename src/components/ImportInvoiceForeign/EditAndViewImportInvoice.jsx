...
import { useGetAllImportForeignQuery } from "../../redux/features/commercial/importInvoiceForeign/queryforeign";
...
const EditAndViewImportInvoice = () => {
  ...
  const { data, isLoading } = useGetAllImportForeignQuery(userName, {
