...
import { useGetCheckByQuery } from "../../redux/features/gatePass/generalForApproval/generalForApprovalQuery";
...
const CheckBy = ({ buttonData }) => {
  ...
  // get table data
  const { data, isLoading, refetch } = useGetCheckByQuery(companyID, {
