...
import { useGetGiftApproveByQuery } from "../../redux/features/gatePass/generalForApproval/generalForApprovalQuery";
...
const GiftApproveBy = ({ buttonData }) => {
  ...
  // get table data
  const { data, isLoading, refetch } = useGetGiftApproveByQuery(companyID, {
