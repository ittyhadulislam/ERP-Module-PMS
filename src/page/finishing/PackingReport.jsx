...
import { useLazyGetDailyPackingReportQuery } from "../../redux/features/finishing/packing/queryPacking";
...
const PackingReport = () => {
  ...
  const handleReport = (e) => {
    ...
    if (title === "Daily Packing Report") {
      getDailyReport({
        id: company?.nCompanyID,
        date: fromDate,
        user: user?.userName,
      });
    } else if (title === "Packing Report- Style Wise") {
      getStyleWiseReport({
        id: company?.nCompanyID,
    ...
    } else if (title === "Packing Report- PO Wise") {
      getPoWiseReport({
        id: company?.nCompanyID,
        styleId: style?.nStyleID,
        style: style?.cStyleNo,
    ...
    } else if (title === "Packing Report- Country Wise") {
      getCountryWiseReport({
        id: company?.nCompanyID,
        styleId: style?.nStyleID,
        style: style?.cStyleNo,
                ...
                options={[
                  {
                    ...
                    label: "Daily Packing Report",
                  },
                  // {
                  //   value: "PaymentModeWiseMonthlyReport",
                  //   label: "Cut to Packing Summary By-D2D",
                  // },
                  {
                    value: "LocalAcceptanceHandOverListReport",
                    label: "Packing Report- Style Wise",
                  },
                  {
                    value: "LocalAcceptanceDocumentListReport",
                    label: "Packing Report- PO Wise",
                  },
                  {
                    value: "LocalAcceptanceDocumentListReport1",
                    label: "Packing Report- Country Wise",
                  },
                ]}
                id="reportName"
                title="Report Name"
            ...
            >
              <Grid container spacing={1} mt={"5px"}>
                ...
                <Grid item xs={12} sm={6}>
                  <CustomDatePicker
                    label={
                      title === "Daily Packing Report" ? "Date" : "From Date"
                    }
                    name={"date"}
                    disableFuture={true}
                    //   prevDate={2}
